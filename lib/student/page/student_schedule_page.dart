...
import '../../common/widget/schedule_item.dart';
import '../../main.dart';
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: scheduleItems.isEmpty
                        ...
                        : ListView.builder(
                            physics:
                                const BouncingScrollPhysics(), // 부드러운 스크롤 추가
                            padding:
                                const EdgeInsets.all(0), // ListView 자체의 여백 제거
                            itemCount: scheduleItems.length,
                            itemBuilder: (context, index) {
                              final schedule = scheduleItems[index];
                              return Padding(
                                padding: const EdgeInsets.symmetric(
                                    vertical: 0.0), // 카드 간의 간격 최소화
                                child: GestureDetector(
                                  ...
                                  child: ScheduleItem(
                                    ...
                                    dotColor:
                                        schedule['mappedColor'], // 매핑된 색상 사용
                                  ),
                                ),
                              );
                            },

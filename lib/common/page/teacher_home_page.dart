    ...
    classData = [
      {
        ...
        'infoItems': [
          ...
          const ClassInfoItem(icon: Icons.access_time, title: '회당 시간', value: '3시간'),
          const ClassInfoItem(
              icon: Icons.calendar_today, title: '요일', value: '월/수/금'),
          const ClassInfoItem(icon: Icons.payment, title: '정산 방법', value: '선불'),
          const ClassInfoItem(icon: Icons.attach_money, title: '시급', value: '12500원'),
      ...
      },
      {
        ...
        'infoItems': [
          const ClassInfoItem(icon: Icons.person, title: '학생 이름', value: '이몽룡'),
          const ClassInfoItem(icon: Icons.access_time, title: '회당 시간', value: '2시간'),
          const ClassInfoItem(icon: Icons.calendar_today, title: '요일', value: '화/목'),
          const ClassInfoItem(icon: Icons.payment, title: '정산 방법', value: '후불'),
          const ClassInfoItem(icon: Icons.attach_money, title: '시급', value: '15000원'),
          const ClassInfoItem(icon: Icons.repeat, title: '수업 횟수', value: '5회'),
          const ClassInfoItem(
